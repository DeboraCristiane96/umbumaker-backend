...
public class ZonaTrabalhoController {
    ...
    @PutMapping("/{codigo}")
    public ResponseEntity<ZonaTrabalho> atualizarZonaTrabalho(@PathVariable(value = "codigo") Long codigo, @RequestBody ZonaTrabalho zonaTrabalho) {
        try {
    ...
    public ResponseEntity<Void> deletarZonaTrabalho(@PathVariable(value = "codigo") Long codigo) {
        try {
